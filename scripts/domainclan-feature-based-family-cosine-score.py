...
parser.add_argument('--pfamscanout_dir', help="Location of directory containing of pfamscanout file (output of domain composition analysis)", required=True, dest="pfamscanout_dir")
parser.add_argument('--output_file', help="Location of the output directory", required=True, dest="output_fileName")
...
def run_workflow(pfamscanout_dirName, output_fileName):
...
#################################################################################################################################################
pfamscanout_dirName = args.pfamscanout_dir
output_fileName=args.output_fileName
run_workflow(pfamscanout_dirName, output_fileName)
